                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          SubscriptionInfoRow(
                                            text: 'Name',
                                            text2:                                 "${widget.subscriptionInfoData['provider'] == null ? "unknown":widget.subscriptionInfoData['provider']['name']}",
                                          ...
                                          SubscriptionInfoRow(
                                            text: 'Description',
                                            text2: widget.subscriptionInfoData['description']??"",
                                            icon: Image.asset(
                                              AppImages.arrowLeft,
                                              width: MySize.size14,
                                              height: MySize.size14,
                                          ...
                                          SubscriptionInfoRow(
                                            text: 'Start Date',
                                            text2: widget.subscriptionInfoData['start_date'] ??"",
                                            icon: Image.asset(
                                              AppImages.arrowLeft,
                                              width: MySize.size14,
                                              height: MySize.size14,
                                          ...
                                          SubscriptionInfoRow(
                                            text: 'Renewal Date',
                                            text2: widget.subscriptionInfoData['renewal_date'] ??"",
                                            icon: Image.asset(
                                              AppImages.arrowLeft,
                                              width: MySize.size14,
                                              height: MySize.size14,
                                          ...
                                          SubscriptionInfoRow(
                                            text: 'Billing Cycle',
                                            text2: widget.subscriptionInfoData['billing_cycle'] ??"",
                                            icon: Image.asset(
                                              AppImages.arrowLeft,
                                              width: MySize.size14,
                                              height: MySize.size14,
                                          ...
                                          SubscriptionInfoRow(
                                            text: 'Reminder',
                                            text2: widget.subscriptionInfoData['reminder'] ??"",
                                            icon: Image.asset(
                                              AppImages.arrowLeft,
                                              width: MySize.size14,
                                              height: MySize.size14,
