...
class _SettingsState extends State<Settings> {
  ...
  List<String> titleText = ['Personal Data', 'Language', 'Currency', 'Change Password' ];
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: Padding(
            ...
            child: AppBar(
              ...
              elevation: 0,
              centerTitle: true,
              title:  Text('Settings',style: TextStyle(color: Color(0XFFA2A2B5),fontSize: MySize.size16, fontWeight: FontWeight.w400),),
              actions: [
                Padding(
              ...
              children: [
                ...
                Padding(
                          ...
                          child: Align(
                            ...
                            child: Text(
                              'Account',
                              style: TextStyle( fontSize: MySize.size14, fontWeight: FontWeight.w600),
                            ),),),
                SizedBox(height: MySize.size8),
                /// Account Container
                Container(
                  ...
                  height: 390,
                  decoration: BoxDecoration(
                    color: Provider.of<ThemeChanger>(context).themeData == darkMode ? Color(0XFF4E4E61).withOpacity(.2) : Colors.white,
                    borderRadius: BorderRadius.circular(16),
                    border: Border(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              ...
                              child: ListTile(
                                ...
                                title: Text('${titleText[index]}', style: TextStyle(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Align(
                                          ...
                                          child: Text('${trailText[index]}', style: TextStyle(
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return ListTile(
                                  dense: true,
                                  leading: Image(image: leadingImage[index],),
                                  title: Text('${titleText2[index]}',
                                    style: TextStyle(
                                      fontSize: MySize.size14,
                                      fontWeight: FontWeight.w600,
                                    ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border(
                      ...
                      top: BorderSide( color: AppColors.whiteFc.withOpacity(0.10), width: 2),
                      // bottom: BorderSide( color: Color(0XFFCFCFFC).withOpacity(.15)),
                      left: BorderSide( color: AppColors.whiteFc.withOpacity(0.10), width: 2),
                    ),
                    // border: Border.all(
                    //   width: MySize.size2,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ManagePlan()));
                          },
                          child: Padding(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => PrivPolicy()));
                          },
                          child: Padding(
                            padding: const EdgeInsets.only(right: 5),
                            child: SettingRowList(
        ...
        child: Row(
          children: [
            Icon(Icons.verified_sharp, color: Color(0XFFA2A2B5), size: 22,),
            SizedBox(width: 14,),
            TextWidgetInterRegular(title: 'Current Version ', fontWeight: FontWeight.w600, fontSize: 14,),
            Spacer(),
            Text( '2.0.24 ', style: TextStyle(
               fontSize: 14,color: Color(0XFFA2A2B5),
            ),),
