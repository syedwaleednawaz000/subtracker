                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: Icon(Icons.mail, color: const Color(0XFF666680).withOpacity(.3),),
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(onPressed: (){
                                  setState(() {
                                    ...
                                    : Icon(Icons.lock_rounded, color: const Color(0XFF666680).withOpacity(.3),)
                                ),
                            ...
                            children: [
                              Checkbox(
                                ...
                                checkColor: Provider.of<ThemeChanger>(context).themeData == darkMode
                                    ...
                                    : const Color(0XFFA2A2B5),
                                side: BorderSide(style: BorderStyle.solid,width: 1, color: const Color(0XFF353542).withOpacity(.95)),
                                value: val,
                    ...
                    return GestureDetector(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                            ...
                            child: Center(
                              child: loginProvider.isLogin == true ? const CircularProgressIndicator(): const Text('Sign In',
