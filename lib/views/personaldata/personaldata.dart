                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: [
                      ...
                      // Positioned widget to place the edit icon
                      Positioned(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            height: 24, // Adjust the size of the icon container
                            width: 24,  // Adjust the size of the icon container
                            decoration: const BoxDecoration(
                              color: Color(0XFFF1F1FF), // Background color for the icon
